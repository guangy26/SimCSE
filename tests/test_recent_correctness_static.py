...
class RecentCorrectnessStaticTests(unittest.TestCase):
    ...
    def test_helper_model_mask_is_frozen_neutral_and_preserves_positives(self):
        source = read_source("train.py")
        ...
        self.assertIn("false_positive_mask.fill_diagonal_(False)", source)
    ...
    def test_distributed_similarity_mask_is_expanded_to_global_logits(self):
        ...
        self.assertIn("global_similarity_mask = similarity_mask.new_ones((z1.size(0), z2.size(0)))", source)
