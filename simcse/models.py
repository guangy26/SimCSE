...
def cl_forward(cls,
    ...
    if dist.is_initialized() and cls.training:
        ...
        if similarity_mask is not None:
            similarity_mask = similarity_mask.to(z1.device)
            ...
            global_similarity_mask = similarity_mask.new_ones(batch_size * world_size, batch_size * world_size)
            for rank_idx, rank_similarity_mask in enumerate(similarity_mask_list):
                rank_start = rank_idx * batch_size
                rank_end = rank_start + batch_size
                global_similarity_mask[rank_start:rank_end, rank_start:rank_end] = rank_similarity_mask
