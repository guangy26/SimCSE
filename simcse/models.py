...
def cl_forward(cls,
    ...
    if dist.is_initialized() and cls.training:
        ...
        if similarity_mask is not None:
            ...
            for process_index, process_similarity_mask in enumerate(similarity_mask_list):
                process_slice = slice(
                    process_index * local_batch_size,
                    (process_index + 1) * local_batch_size,
                )
                global_similarity_mask[process_slice, process_slice] = process_similarity_mask
