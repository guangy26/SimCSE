...
def cl_forward(cls,
    ...
    if dist.is_initialized() and cls.training:
        ...
        if similarity_mask is not None:
            ...
            similarity_mask_global = torch.ones(
                local_batch_size * dist.get_world_size(),
                local_batch_size * dist.get_world_size(),
            ...
            for rank, rank_similarity_mask in enumerate(similarity_mask_list):
                ...
                similarity_mask_global[start:end, start:end] = rank_similarity_mask
            similarity_mask = similarity_mask_global
    ...
    if similarity_mask is not None:
        similarity_mask = similarity_mask.to(cos_sim.device)
