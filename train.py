    ...
    class OurDataCollatorWithPadding:
        ...
        def __call__(self, features: List[Dict[str, Union[List[int], List[List[int]], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
            ...
            if self.help_model is not None:
                ...
                original_embeddings = mean_pool(original_outputs.last_hidden_state, original_attention_mask) # (bs, dim)
                similar_embeddings = mean_pool(similar_outputs.last_hidden_state, similar_attention_mask) # (bs, dim)
