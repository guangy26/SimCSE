    ...
    class OurDataCollatorWithPadding:
        ...
        def __call__(self, features: List[Dict[str, Union[List[int], List[List[int]], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
            ...
            if self.help_model is not None:
                ...
                # Compute helper-model similarities without tracking gradients.
                with torch.no_grad():
                ...
                # Raw cosine scores must be used for thresholds; the loss applies temperature later.
                ...
                positive_indices = torch.arange(bs, device=similarity_mask.device)
                similarity_mask[positive_indices, positive_indices] = 1.0
        ...
        def mask_tokens(
            ...
            # The rest of the time, keep masked input tokens unchanged.
