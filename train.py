...
from simcse.masking import build_similarity_mask
    ...
    class OurDataCollatorWithPadding:
        ...
        def __call__(self, features: List[Dict[str, Union[List[int], List[List[int]], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
            ...
            if self.help_model is not None:
                ...
                batch["similarity_mask"] = build_similarity_mask(
                    original_embeddings,
                    similar_embeddings,
                    self.similarity_threshold_high,
                    self.similarity_threshold_low,
                )
        ...
        def mask_tokens(
            ...
            # The rest of the time (10% of masked tokens), keep the masked input tokens unchanged.
