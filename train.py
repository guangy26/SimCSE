    ...
    class OurDataCollatorWithPadding:
        ...
        def __call__(self, features: List[Dict[str, Union[List[int], List[List[int]], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
            ...
            if self.help_model is not None:
                ...
                # use the frozen helper model to get attention-mask-aware embeddings
                with torch.no_grad():
                ...
                similarity_mask = similarity_scores.clamp_min(torch.finfo(similarity_scores.dtype).tiny)
        ...
        def mask_tokens(
            ...
            # The rest of the time, keep the masked input tokens unchanged.
